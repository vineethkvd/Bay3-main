...
class FavoriteOrCartProductModel {
  final int id;
  final int price;
  final int oldPrice;
  final int discount;
  ...
  factory FavoriteOrCartProductModel.fromJson(Map<String, dynamic> json) {
    return FavoriteOrCartProductModel(
      id: json['id'],
      price: json['price'].ceil(),
      oldPrice: json['old_price'].ceil(),
      discount: json['discount'].ceil(),
      image: json['image'],
      name: json['name'],
